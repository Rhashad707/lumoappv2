...
const features = [
  {
    ...
    description: "Get precise directions on an interactive map, guiding you shelf by shelf."
  },
  {
    icon: <SmartListRoutingIcon />,
    title: "Smart Lists with Instant Routing",
    description: "Your shopping list is instantly converted into the most efficient path through the store."
  },
  {
    icon: <AllergyFilterIcon />,
    title: "Allergy & Dietary Smart Filters",
    description: "Set your dietary needs and Lumo will flag products and suggest safe alternatives."
  },
  {
    icon: <AiAssistantIcon />,
    title: "Built-In AI Shopping Assistant",
    description: "Ask for product locations, recipe ideas, or comparisons on the fly."
  },
  {
    icon: <SharedListsIcon />,
    title: "Shared Lists for Collaborative Shopping",
    description: "Coordinate with family in real-time. Add items and see updates instantly."
  },
  {
    icon: <PriceTrackIcon />,
    title: "Live Price Tracking & Smart Swaps",
    description: "Track your spending as you shop and get alerts for better-value items nearby."
  },
  {
    icon: <AugmentedRealityIcon />,
    title: "Augmented Reality Navigation",
    description: "See exactly where to go with real-time arrows that guide you through the aisles."
  }
];
